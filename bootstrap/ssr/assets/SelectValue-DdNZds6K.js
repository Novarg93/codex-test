import { unref, mergeProps, withCtx, renderSlot, useSSRContext, createVNode } from "vue";
import { ssrRenderComponent, ssrRenderSlot } from "vue/server-renderer";
import { reactiveOmit } from "@vueuse/core";
import { useForwardPropsEmits, SelectRoot, SelectPortal, SelectContent, SelectViewport, SelectGroup, useForwardProps, SelectItem, SelectItemIndicator, SelectItemText, SelectScrollDownButton, SelectScrollUpButton, SelectTrigger, SelectIcon, SelectValue } from "reka-ui";
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(SelectViewport), {
                    class: unref(cn)(
                      "p-1",
                      __props.position === "popper" && "h-[--reka-select-trigger-height] w-full min-w-[--reka-select-trigger-width]"
                    )
                  }, {
